...
class CheckVideos():
    def __init__(self, window):
        ...
        back_btn = tk.Button(window, text="Back To Main", command=self.back_to_main_clicked, bg="red", activebackground="#8B0000")
        back_btn.grid(row=2, column=3, padx=10, pady=10)
